...
?>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title">
                <h4 class="float-left"> Search Employee as Appraisor</h4>
                <ol class="breadcrumb">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
                <div class="panel-body  p-xl-3">
				    ...
				    <li class="active"><a data-toggle="tab" aria-expanded="true" href="#kra">KRA</a></li>
				    <li><a data-toggle="tab" href="#csf">CSF</a></li>
		                    <li><a data-toggle="tab" href="#pplan">Performance Plan</a></li>
		                    <li><a data-toggle="tab" href="#devplan">Development Plan</a></li>
			        </ul>
<br><br>
			  <div class="tab-content">
			   <div id="kra" class="tab-pane fade in active">
			    ...
			    <div id="csf" class="tab-pane fade ">
			...
			<div id="pplan" class="tab-pane fade">
    			...
    			<div id="devplan" class="tab-pane fade">
