								...
								<form role="form">
									<div class="form-body">
										...
										<div class="form-group">
											...
											<input name="time_duration" type="date" class="form-control" placeholder="Time Duration">
										</div>
										<div class="radio-list form-group">
											<label>Available</label>
											<label><input type="checkbox" value="0" name="available[]">Lunch</label>
											<label><input type="checkbox" value="1" name="available[]">Dinner</label>
											<label><input type="checkbox" value="2" name="available[]">Breakfast</label>
										</div>
