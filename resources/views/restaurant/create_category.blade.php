									...
									<div class="form-body">
										...
										<div class="radio-list form-group">
											<label>Available</label>
												...
												<div class="radio" id="uniform-optionsRadios4"><input type="radio" name="avaliable" value="1" checked=""></div> Yes </label>
												<label class="radio-inline">
												<div class="radio" id="uniform-optionsRadios5"><input type="radio" name="avaliable" value="0"></div> No </label>
										</div>
										<div class="form-group">
											<label>Tax</label>
