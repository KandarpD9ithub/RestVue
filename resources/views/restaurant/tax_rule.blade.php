				...
				<div class="row">
					<div class="portlet box red-intense">
							<div class="portlet-title">
								...
								<div class="tools">
									<span class="">
										<a href="create_tax_rule.html">
											<button  class="btn btn-success linkButton" type="button"> 
									Add</button></a>
													</span>
									
								</div>
							</div>
							<div class="portlet-body"><table class="table table-striped table-bordered table-hover" id="sample_1">
								<thead>
								<tr>
									<th>
										 Rendering engine
